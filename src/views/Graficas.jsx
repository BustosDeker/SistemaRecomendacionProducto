...
const Graficas = ({ historialCompras }) => {
  ...
  const datosGraficas = useMemo(() => {
    ...
    // 4. Evolución de compras en el tiempo
    ...
    return (
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
        ...
        <p className="text-gray-600">
          Realiza algunas compras para ver tus estadísticas y gráficas
          personalizadas
        </p>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Gráfica 1: Productos por Categoría (Barras) */}
        ...
        {/* Gráfica 2: Distribución de Categorías (Pie) */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
        ...
        {/* Gráfica 3: Gasto por Categoría (Barras Horizontales) */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
        ...
        {/* Gráfica 4: Evolución de Compras (Línea) */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
